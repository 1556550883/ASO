...
//  test1
//
//  Created by 文高坡 on 2017/9/24.
//  Copyright © 2017年 文高坡. All rights reserved.
//
...
class SQLiteManager: NSObject {
    ...
    func openDB() -> Bool {
        ...
        let DBPath = (dicumentPath! as NSString).appendingPathComponent("aso.sqlite")
    ...
    func creatTable() -> Bool {
        ...
        return creatTableExecSQL(SQL_ARR: [creatUserTable, creatAdvDateTable])
    }
