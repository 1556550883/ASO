...
{
    private init(){};
    public static func parseResponse(view:UIViewController, response:DataResponse<Any>, successHandler:(([String:AnyObject],String)->Void)? = nil, errorHandler:(()->Void)? = nil)->Void
    {
